...
import { MOCK_CLIENTES, type Cliente } from "@/lib/data/clientes"
...
export const clientesData = MOCK_CLIENTES
...
export { MOCK_EMPLEADOS, MOCK_SUCURSALES, MOCK_CLIENTES, MOCK_SERVICIOS }
